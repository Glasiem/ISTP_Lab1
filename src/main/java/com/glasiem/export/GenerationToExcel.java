...
public class GenerationToExcel {
    private XSSFWorkbook excelWorkbook;
    private XSSFSheet excelSheet;
    private List<GenerationEntity> generations;

    public GenerationToExcel(List<GenerationEntity> generations) {
    ...
    private void writeData() {
        ...
        for (GenerationEntity generation : generations) {
            ...
            createCell(row, columnCount++, generation.getId(), style);
            createCell(row, columnCount++, generation.getName(), style);
            createCell(row, columnCount++, generation.getInfo(), style);
            createCell(row, columnCount++, generation.getAgency().getName(), style);
