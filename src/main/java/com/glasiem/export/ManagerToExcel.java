...
public class ManagerToExcel {
    private XSSFWorkbook excelWorkbook;
    private XSSFSheet excelSheet;
    private List<ManagerEntity> managers;

    public ManagerToExcel(List<ManagerEntity> managers) {
    ...
    private void writeData() {
        ...
        for (ManagerEntity manager : managers) {
            ...
            createCell(row, columnCount++, manager.getId(), style);
            createCell(row, columnCount++, manager.getName(), style);
            createCell(row, columnCount++, manager.getInfo(), style);
            createCell(row, columnCount++, manager.getAgency().getName(), style);
