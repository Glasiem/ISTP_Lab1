...
public class AgencyToExcel {
    private XSSFWorkbook excelWorkbook;
    private XSSFSheet excelSheet;
    private List<AgencyEntity> agencies;

    public AgencyToExcel(List<AgencyEntity> agencies) {
    ...
    private void writeData() {
        ...
        for (AgencyEntity agency : agencies) {
            ...
            createCell(row, columnCount++, agency.getId(), style);
            createCell(row, columnCount++, agency.getName(), style);
            createCell(row, columnCount++, agency.getInfo(), style);
